      ...
      try {
        ...
        case e: java.sql.SQLException =>
          DB autoCommit { implicit s =>
            ...
            sql"INSERT INTO assumptions(assumption, url) values ('Ordinal responses', null);".execute.apply()
            sql"INSERT INTO assumptions(assumption, url) values ('Random samples from populations', null);".execute.apply()
            sql"INSERT INTO assumptions(assumption, url) values ('The type of the measured data to be at least on an ordinal scale (no normality needed)', null);".execute.apply()
            ...
            sql"INSERT INTO assumptions(assumption, url) values ('One dependant variable which should be either ordinal interval or ratio', null);".execute.apply()
            ...
            sql"INSERT INTO assumptions(assumption, url) values ('Simple random samples', 'http://en.wikipedia.org/wiki/Simple_random_sample');".execute.apply()
