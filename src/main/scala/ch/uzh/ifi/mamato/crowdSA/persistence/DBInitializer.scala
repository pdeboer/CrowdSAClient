      ...
      try {
        ...
        case e: java.sql.SQLException =>
          DB autoCommit { implicit s =>
            ...
            sql"INSERT INTO assumption2questions(assumption_id, question, test_names) values (4, 'Id the Glejser test used to test the Homoscedasticity (AKA Constant Variance)?', 'Glejser,heteroscedasticity,regression,residuals,ordinary least square,sample residuals,R2');".execute.apply()
