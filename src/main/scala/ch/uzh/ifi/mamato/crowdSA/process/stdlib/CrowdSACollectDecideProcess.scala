...
object CrowdSACollectDecideProcess {
  ...
  val COLLECT = new ProcessParameter[PassableProcessParam[CreateProcess[CrowdSAQuery, List[Answer]]]]("collect", None)
  val DECIDE = new ProcessParameter[PassableProcessParam[DecideProcess[List[Answer], Answer]]]("decide", None)
